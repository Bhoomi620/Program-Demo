...
function display(arrayProduct)
{
    ...
    let productcards = arrayProduct.map(function(value,index){
        ...
        <div class="card-body">
          ...
          <button class="btn btn-primary" onclick="addtocart(${index})">add cart</button>
        </div>
      </div></div>`)
...
function addtocart(index)
{
  ...
  {
    carts[index].quan = carts[myindex].quan+1;
  }
...
function displayprice()
{
  ...
  let p= carts.reduce(function(prev,cur){

    return prev + cur.quan * cur.price;
  },0)
